...
import chair5 from '../assets/Image (7).png';
import chair6 from '../assets/Image (8).png';
import chair7 from '../assets/Image (9).png';
...
<div className = " w-[312px] h-[377px] absolute top-[542px] ">
    ...
    <Image src = {chair5} alt = "toolchair" className = "w-[312px] h-[312px] rounded-md"/> 
...
<div className = "w-[312px] h-[377px] absolute top-[542px]   left-[336px]"> 
    ...
    <Image src = {chair6} alt = "greystoolchair" className ="w-[312px] h-[312px] rounded-[10px] "/>
...
<div className = "w-[312px] h-[377px] absolute top-[542px] left-[672px] ">
    ...
    <Image src = {chair7} alt = "Blacktoolchair" width={312} height={312} className = "rounded-[10px]" />
...
<div className = "w-[312px] h-[377px] absolute top-[542px] left-[1008px] ">
    ...
    <Image src = {chair} alt = "whitetoolchair" width={312} height={312} className = "rounded-[10px]" />
