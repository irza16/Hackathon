...
const targetClient = createClient({
  ...
  dataset: process.env.NEXT_PUBLIC_SANITY_DATASET, // Default to "production" if not set
  useCdn: false, // Disable CDN for real-time updates
  apiVersion: "2023-01-01", // Sanity API version
  token:process.env.NEXT_PUBLIC_SANITY_AUTH_TOKEN, // API token for authentication
});
